...
--
-- Host: 127.0.0.1
-- Generation Time: May 26, 2021 at 10:37 AM
...
(11, 'Jujustu Kaisen ', '11.jpg', 'Gege Akutami', 'Jujutsu Kaisen fokus menceritakan seorang siswa bernama Yuuji Itadori. Ia tergabung dalam klub ilmu gaib, namun suatu hari klub tersebut mendapatkan benda terkutuk yang disegel.', '40.000', 'Komik'),
(18, 'Attack on Titan', '12.jpg', 'Hajime Isayama', 'Attack on Titan Alkisah suatu ketika makhluk humanoid yang bernama titan membunuhi umat manusia sejak berabad-abad lamanya. Titan tidak akan membiarkan satu manusia pun untuk hidup. Akibatnya, jumlah manusia turun sangat banyak, bahkan saat itu berada di tengah kepunahan.', '40.000', 'Komik'),
(27, 'Milea', 'milea.jpg', 'Pidi Baiq', 'Novel ini menceritakan pengenalan singkat Dilan waktu dia masih kecil, ia pernah ingin menjadi macan walaupun itu tidak mungkin dimasa kecilnya Dilan selalu berfikir bahwa dia mempunyai masa kecil yang benar-benar bahagia', '70.000', 'Novel');
...
(2, 'mala', '$2y$10$aQ5uMdOXbcjCeRatwuZLGuPFOyTOqkyYefl2Bvh3PHvAE351piMeu'),
(4, 'sitikomalasari', '$2y$10$.7VGNVHIDr54NPtEyXmleeh1hoRqeOx.IMM8op.1huzcOx7GMk8TK'),
(7, 'admin', '$2y$10$vDKBpn7hzLd.hXb0shccweifoeqzL6tzuSAMVg4PdN10neVn4IxoW');
...
--
ALTER TABLE `buku`
  MODIFY `id_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
